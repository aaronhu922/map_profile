...
class MapStudentProfile(models.Model):
    ...
    Informational_Text_Key_Ideas_and_Details_SCORE = models.CharField(max_length=10, null=True)
    Informational_Text_Key_Ideas_and_Details_STANDARD_ERROR = models.CharField(max_length=16, null=True)
    Vocabulary_Acquisition_and_Use_SCORE = models.CharField(max_length=10, null=True)
    Vocabulary_Acquisition_and_Use_STANDARD_ERROR = models.CharField(max_length=16, null=True)
    Informational_Text_Language_Craft_and_Structure_SCORE = models.CharField(max_length=10, null=True)
    Informational_Text_Language_Craft_and_Structure_STANDARD_ERROR = models.CharField(max_length=16, null=True)
    Literary_Text_Language_Craft_and_Structure_SCORE = models.CharField(max_length=10, null=True)
    Literary_Text_Language_Craft_and_Structure_STANDARD_ERROR = models.CharField(max_length=16, null=True)
    Literary_Text_Key_Ideas_and_Details_SCORE = models.CharField(max_length=10, null=True)
    Literary_Text_Key_Ideas_and_Details_STANDARD_ERROR = models.CharField(max_length=16, null=True)
