cell_text = [
    ...
    ["", "", "", "", "", "", "", "L.4.3.C", ""],
    ["", "", "", "L.K.4", "L.1.4", "L.2.4", "L.3.4", "L.4.4", "L.5.4"],
    ...
    ["", "", "", "SL.K.1", "SL.1.1", "SL.2.1", "SL.3.1", "SL.4.1", "SL.5.1.1"],
    ...
    ["", "", "", "SL.K.4", "SL.1.4", "SL.2.4", "SL.3.4", "SL.4.1.4", "SL.5.4"],
    ...
    ["", "", "", "", "", "", "", "W.4.9.A", "W.5.9.A"],
    ["", "", "", "", "", "", "", "W.4.9.B", "W.5.9.B"],
    ["", "", "", "W.K.10", "W.1.10", "W.2.10", "W.3.10", "W.4.10", "W.5.10"],
    ["", "", "", "RF.K.1", "RF.1.1", "", "", "", ""],
    ["", "", "", "RF.K.1.A", "RF.1.1.A", "", "", "", ""],
    ["", "", "", "RF.K.1.B", "", "", "", "", ""],
    ["", "", "", "RF.K.1.C", "", "", "", "", ""],
    ...
    ["", "", "", "RF.K.2.D", "RF.1.2.D", "", "", "", ""],
    ["", "", "", "RF.K.2.E", "", "", "", "", ""],
    ["", "", "", "RF.K.3", "RF.1.3", "RF.2.3", "RF.3.3", "RF.4.3", "RF.5.3"],
    ...
    ["", "", "", "", "RF.1.3.F", "RF.2.3.F", "", "", ""],
    ["", "", "", "", "RF.1.3.G", "", "", "", ""],
    ["", "", "", "RF.K.4", "RF.1.4", "RF.2.4", "RF.3.4", "RF.4.4", "RF.5.4"],
    ...
    ["", "", "", "RI.K.10", "RI.1.10", "RI.2.10", "RI.3.10", "RI.4.10", "RI.5.10"]
]
...
for i in range(len(cell_text)):
    for j in range(len(cell_text[i])):
        if cell_text[i][j] != "":
            print(cell_text[i][j] + str((i, j)))
            count += 1
            items_indexes.append((i, j))
            indexes_dict[cell_text[i][j]] = (i, j)
print(count)
print(indexes_dict)
print(len(indexes_dict))
